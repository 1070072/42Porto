...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/18 23:34:22 by jf                #+#    #+#             */
/*   Updated: 2023/03/19 11:53:56 by jf               ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_table(int board[][4])
{
	int	i;
	int	c;
...
bool	ft_is_valid(int board[][4], int row, int col, int num) 
{
	int i;
...
void ft_combinations(int board[][4], int row, int col) 
{
	//int count;
	int num;
    ...
    while (++num <= 4) 
	{
		...
		{
            board[row][col] = num;
            ft_combinations(board, row, col + 1);
            board[row][col] = 0;
        }
    }
}
